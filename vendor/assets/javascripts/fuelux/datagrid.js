...
+function ($) {
    ...
    Datagrid.prototype = {
        ...
        _updateColumns: function ($header, $target, direction) {
            var className = (direction === 'asc') ? 'glyphicon-chevron-up' : 'glyphicon-chevron-down';
    ...
    $.fn.datagrid.defaults = {
        ...
        loadingHTML: '<div class="progress progress-striped active" style="width:50%;margin:auto;"><div class="progress-bar" style="width:100%;"></div></div>',
        itemsText: 'items',
        itemText: 'item'
    };
