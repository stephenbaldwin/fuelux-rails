        ...
        selectItem: function (el) {
            ...
            if (this.options.multiSelect) {
                ...
                $all.removeClass('tree-selected')
                    .find('i').removeClass('glyphicon').removeClass('glyphicon-ok').addClass('tree-dot');
                data.push($el.data());
            }

            if ($el.hasClass('tree-selected')) {
                $el.removeClass('tree-selected');
                $el.find('i').removeClass('glyphicon').removeClass('glyphicon-ok').addClass('tree-dot');
            } else {
                $el.addClass('tree-selected');
                $el.find('i').removeClass('tree-dot').addClass('glyphicon').addClass('glyphicon-ok');
                if (this.options.multiSelect) {
                    data.push($el.data());
                }
            }
